...
<!-- Chartlist chart css -->
<link rel="stylesheet" href="<%= request.getContextPath() %>/assets/plugins/chartist/dist/chartist.css"
	type="text/css" media="all">

<!-- Weather css -->
<link href="<%= request.getContextPath() %>/assets/css/svg-weather.css" rel="stylesheet">
