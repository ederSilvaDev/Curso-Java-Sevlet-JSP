...
<nav class="navbar navbar-static-top">
	...
	<ul class="top-nav lft-nav">
		<li><a href="#!" data-toggle="dropdown" role="button"
			...
			class="dropdown-toggle drop icon-circle drop-image"> <i
				class="ti-files"> </i><span> Arquivos</span>
		</a></li>
	...
	<div class="navbar-custom-menu f-right">
		<!-- <div class="upgrade-button">
			<a href="#"
				class="icon-circle txt-white btn btn-sm btn-primary upgrade-button img-responsive btn-md btn-block waves-effect">
		...
		<ul class="top-nav">
			...
			<a href="#!"
				data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle">
					...
					class="badge badge-danger header-badge"></span>
			</a>
				<!-- <ul class="dropdown-menu">
					...
					<li class="bell-notification"><a href="javascript:;"
						class="media"> <span class="media-left media-icon"> <img
								class="img-circle" src="/assets/images/avatar-1.png"
								alt="User Image">
						</span>
					...
					<li class="bell-notification"><a href="javascript:;"
						class="media"> <span class="media-left media-icon"> <img
								class="img-circle" src="/assets/images/avatar-2.png"
								alt="User Image">
						</span>
							<div class="media-body">
					...
					<li class="not-footer"><a href="#!">See all notifications.</a>
					</li>
				</ul></li> -->
			<!-- chat dropdown -->
			<li class="pc-rheader-submenu "><a href="#!"
				class="drop icon-circle displayChatbox"> <i class="icon-bubbles"></i>
			...
			<li class="dropdown"><a href="#!" data-toggle="dropdown"
				...
				class="dropdown-toggle drop icon-circle drop-image"> <span><img
						class="img-circle " src="<%= request.getContextPath() %>/assets/images/avatar-1.png"
						style="width: 40px;" alt="User Image"></span> <%= session.getAttribute("usuario") %><span>
				...
				<ul class="dropdown-menu settings-menu">
					...
					<li><a href="#"><i class="icon-lock"></i> Encerrar</a></li>
			...
			<div class="morphsearch-content">
				...
				<div class="dummy-column">
					...
					<a class="dummy-media-object" href="#!"> <img
						src="<%= request.getContextPath() %>/assets/images/avatar-1.png" alt="PagePreloadingEffect" />
						<h3>Page Preloading Effect</h3>
					</a> <a class="dummy-media-object" href="#!"> <img
						src="<%= request.getContextPath() %>/assets/images/avatar-1.png" alt="DraggableDualViewSlideshow" />
				...
				<div class="dummy-column">
					<h2>Recent</h2>
					<a class="dummy-media-object" href="#!"> <img
						src="<%= request.getContextPath() %>/assets/images/avatar-1.png" alt="TooltipStylesInspiration" />
						<h3>Tooltip Styles Inspiration</h3>
					</a> <a class="dummy-media-object" href="#!"> <img
						src="<%= request.getContextPath() %>/assets/images/avatar-1.png" alt="NotificationStyles" />
