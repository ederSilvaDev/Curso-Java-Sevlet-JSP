				...
				<div class="col-xs-12">
					<div class="login-card card-block">
						<form class="md-float-material">
							...
							<h3 class="text-primary text-center m-b-25">Recuperar Senha</h3>

							<div class="md-group">
								<div class="md-input-wrapper">
									<input type="text" class="md-form-control" /> <label>Email
										ou Número de Celular</label>
								</div>
							</div>
							<div class="btn-forgot">
								<button type="reset"
									class="btn btn-primary btn-md waves-effect waves-light text-center">ENVIAR LINK</button>
							</div>
							<div class="row">
								<div class="col-xs-12 text-center m-t-25">

									<a href="login1.html" class="f-w-600 p-l-5">Entre Aqui</a>
